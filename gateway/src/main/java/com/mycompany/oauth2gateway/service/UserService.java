package com.mycompany.oauth2gateway.service;

import com.mycompany.oauth2gateway.domain.Authority;
import com.mycompany.oauth2gateway.domain.User;
import com.mycompany.oauth2gateway.repository.AuthorityRepository;
import com.mycompany.oauth2gateway.config.Constants;
import com.mycompany.oauth2gateway.repository.UserRepository;
import com.mycompany.oauth2gateway.security.SecurityUtils;
...
public class UserService {
    ...
    public UserDTO getUserFromAuthentication(OAuth2Authentication authentication) {
        ...
        // The Map detail are available only because the user-info endpoint strategy is used !
